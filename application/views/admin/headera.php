    ...
    <nav class="navbar navbar-default">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url().'admin'; ?>">Kunjuangan</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="<?php echo base_url().'admin/mobil'; ?>"><span
                                class="glyphicon glyphicon-folder-open"></span> Data Gedung</a></li>
                    <li><a href="<?php echo base_url().'admin/kostumer'; ?>"><span
                                class="glyphicon glyphicon-user"></span> Data Pengunjung</a></li>
                    <li><a href="<?php echo base_url().'admin/transaksi'; ?>"><span
                                class="glyphicon glyphicon-sort"></span> melakukan kunjunan</a></li>
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                            aria-expanded="false"><?php echo "Halo semua, <b>".$this->session->userdata('nama'); ?></b>
