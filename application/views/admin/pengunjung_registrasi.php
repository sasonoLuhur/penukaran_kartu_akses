    ...
    <div class="container-scroller">
        ...
        <div class="container-fluid page-body-wrapper">
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo base_url().'admin' ?>"> <i class="icon-grid menu-icon"></i>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="form-sample"
                                        action="<?php echo base_url().'admin/pengunjung_registrasi_add_act'?>"
                                        method="post">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select name="jenis_kelamin" class="form-control">
                                                            <option value="0" disabled selected="selected">Pilih
                                                            </option>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="tujuan" name="tujuan" required class="form-control">
                                            <option value="0" disabled selected="selected">Pilih tujuan</option>
