...
<head>
    ...
    <title>Aplikasi Tamu - Deaktivasi Kartu</title>
    <!-- plugins:css -->
                ...
                <div class="content-wrapper">
                    <div class="row">
                        ...
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Dektivasi Kartu</h4>
                                                ...
                                                <tr>
                                                    ...
                                                    <th>
                                                        ...
                                                        <a class="btn btn-success btn-sm"
                                                            href="<?php echo base_url().'admin/pengunjung_deaktivasi/'.$p->pengunjung_id; ?>">
                                                            <span class="glyphicon glyphicon-trash"></span> Deaktivasi</a>
