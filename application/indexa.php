			...
			<div class="panel-heading">
				<div class="row">
					...
					<div class="col-xs-9 text-right">
						<div class="huge">
							<?php echo $this->m_kartu->get_data('mobil')->num_rows(); ?>
						</div>
		...
		<div class="panel panel-success">
			<div class="panel-heading">
				<div class="row">
					...
					<div class="col-xs-9 text-right">
						<div class="huge">
							<?php echo $this->m_kartu->get_data('kostumer')->num_rows(); ?>
						</div>
		...
		<div class="panel panel-warning">
			<div class="panel-heading">
				<div class="row">
					...
					<div class="col-xs-9 text-right">
						<div class="huge">
							<?php echo $this->m_kartu->get_data('transaksi')->num_rows(); ?>
						</div>
		...
		<div class="panel panel-danger">
			<div class="panel-heading">
				<div class="row">
					...
					<div class="col-xs-9 text-right">
						<div class="huge">
							<?php echo $this->m_kartu->edit_data(array('transaksi_status'=>1),'transaksi')->num_rows(); ?>
						</div>
